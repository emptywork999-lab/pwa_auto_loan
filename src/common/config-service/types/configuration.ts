...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  configurations = {
     ...
     * @tags Configuration
     * @name FindByChannel
     * @summary Find a config by Channel
     * @request GET:/configurations/data
     * @secure
     */
    findByChannel: (channel: string, params: RequestParams = {}) =>
      this.request<ConfigurationDataResponse, any>({
        path: `/configurations/data`,
        method: "GET",
        secure: true,
        format: "json",
        ...params,
